        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0"><i class="bi bi-plus-circle"></i> Create Stock Transaction</h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="quantity_before" id="quantity_before" class="form-control @error('quantity_before') is-invalid @enderror" 
                                       value="{{ old('quantity_before') }}" min="0" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="quantity_after" id="quantity_after" class="form-control @error('quantity_after') is-invalid @enderror" 
                                       value="{{ old('quantity_after') }}" min="0" required>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select name="reference_type" id="reference_type" class="form-select @error('reference_type') is-invalid @enderror">
                                    ...
                                    <option value="purchase_request" {{ old('reference_type') == 'purchase_request' ? 'selected' : '' }}>Purchase Request</option>
                                    <option value="procurement" {{ old('reference_type') == 'procurement' ? 'selected' : '' }}>Procurement</option>
                                    <option value="manual" {{ old('reference_type') == 'manual' ? 'selected' : '' }}>Manual Adjustment</option>
                                    <option value="return" {{ old('reference_type') == 'return' ? 'selected' : '' }}>Return</option>
                                    <option value="damage" {{ old('reference_type') == 'damage' ? 'selected' : '' }}>Damage</option>
